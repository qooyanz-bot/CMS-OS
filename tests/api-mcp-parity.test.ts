...
const openApiOperationToMcpTool: Record<string, string> = {
  ...
  createPortalPlan: "portal.plan",
  listPortalPlans: "portal.plan.list",
  getPortalPlan: "portal.plan.get",
  applyPortalPlan: "portal.plan.apply",
  draftPortalPlan: "portal.plan.draft",
  ...
  compareProviders: "provider.compare",
  listFavorites: "favorite.list",
  createFavorite: "favorite.add",
  deleteFavorite: "favorite.remove",
  ...
  listWebhookSubscriptions: "webhook.list",
  createWebhookSubscription: "webhook.create",
  updateWebhookSubscription: "webhook.update",
  revokeWebhookSubscription: "webhook.revoke",
  listWebhookDeliveries: "webhook.deliveries",
  retryWebhookDelivery: "webhook.retry",
  deliverWebhook: "webhook.deliver",
  deliverPendingWebhooks: "webhook.deliver_pending",
  submitAsyncOperation: "operation.submit",
  listAsyncOperations: "operation.list",
  getAsyncOperation: "operation.get",
  executeAsyncOperation: "operation.execute",
  executePendingAsyncOperations: "operation.execute_pending",
  createContentProposal: "content.propose",
  createContent: "content.create",
  listContentProposals: "content.proposals",
  createContentDraft: "content.draft",
  listContents: "content.list",
  updateContent: "content.update",
  listContentEditorialActions: "content.editorial_actions",
  createContentCorrection: "content.correction",
  withdrawContent: "content.withdrawal",
  ...
  updateBookingStatus: "booking.update_status",
