  ...
  return {
    ...
    roles: {
      ...
      orderer: {
        ...
        allowedActions: [...commonActions, "request.create", "request.message", "request.quote.read", "request.read", "request.status.update"],
  ...
  beauty: {
    ...
    roles: {
      ...
      orderer: {
        ...
        visibleFields: ["publicFields", "ordererFields", "verificationStatus", "lastVerifiedAt"],
        allowedActions: [...commonActions, "request.create", "booking.create", "booking.read", "booking.status.update", "request.message", "request.read", "request.status.update"],
