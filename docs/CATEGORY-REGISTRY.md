...
- `candidate`: 求人、事業者情報、カルチャー、応募、応募状況を利用できます。応募書類と選考情報は本人と関係事業者に限定します。
...
新規環境は[`001_initial.sql`](../db/migrations/001_initial.sql)を適用します。既存環境で初期マイグレーションを適用済みの場合は、[`003_expand_category_slugs.sql`](../db/migrations/003_expand_category_slugs.sql)を追加適用してカテゴリ制約を更新します。
